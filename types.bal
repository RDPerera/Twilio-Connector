...
public type ListIncomingPhoneNumberLocalResponse record {
    Incomming_phone_numIncoming_phone_number_local[] incoming_phone_numbers?;
    int end?;
    string first_page_uri?;
    string? next_page_uri?;
    int page?;
...
public type ApiV2010AccountAvailable_phone_number_countryAvailable_phone_number_shared_cost record {
    ...
    Available_phone_number_capabilities? capabilities?;
};
...
public type Incomming_phone_numIncoming_phone_number_toll_free record {
    ...
    boolean? beta?;
    # The set of Boolean properties that indicate whether a phone number can receive calls or messages.  Capabilities are  `Voice`, `SMS`, and `MMS` and each capability can be: `true` or `false`.
    Incomming_phone_num_capabilities? capabilities?;
    # The date and time in GMT that the resource was created specified in [RFC 2822](https://www.ietf.org/rfc/rfc2822.txt) format.
    string? date_created?;
    # The date and time in GMT that the resource was last updated specified in [RFC 2822](https://www.ietf.org/rfc/rfc2822.txt) format.
    string? date_updated?;
...
public type Incomming_phone_numIncoming_phone_number_mobile record {
    # The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the resource.
    string? account_sid?;
    # The SID of the Address resource associated with the phone number.
    string? address_sid?;
...
public type Incomming_phone_numIncoming_phone_number_assigned_add_on record {
    # The unique string that that we created to identify the resource.
    string? sid?;
    # The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the resource.
    string? account_sid?;
...
public type ListIncomingPhoneNumberMobileResponse record {
    Incomming_phone_numIncoming_phone_number_mobile[] incoming_phone_numbers?;
    int end?;
    string first_page_uri?;
    string? next_page_uri?;
    int page?;
...
public type ListIncomingPhoneNumberAssignedAddOnResponse record {
    Incomming_phone_numIncoming_phone_number_assigned_add_on[] assigned_add_ons?;
    int end?;
    string first_page_uri?;
    string? next_page_uri?;
    int page?;
...
public type ListIncomingPhoneNumberAssignedAddOnExtensionResponse record {
    Incomming_phone_numIncoming_phone_number_assigned_add_onIncoming_phone_number_assigned_add_on_extension[] extensions?;
    int end?;
    string first_page_uri?;
    string? next_page_uri?;
    int page?;
...
public type Incomming_phone_num record {
...
# The set of Boolean properties that indicate whether a phone number can receive calls or messages.  Capabilities are: `Voice`, `SMS`, and `MMS` and each capability can be: `true` or `false`.
public type Available_phone_number_capabilities record {
    boolean mms?;
    boolean sms?;
    boolean voice?;
    boolean fax?;
...
public type ListIncomingPhoneNumberResponse record {
    Incomming_phone_num[] incoming_phone_numbers?;
    int end?;
    string first_page_uri?;
    string? next_page_uri?;
    int page?;
...
public type Incomming_phone_numIncoming_phone_number_local record {
    # The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the resource.
    string? account_sid?;
    # The SID of the Address resource associated with the phone number.
    string? address_sid?;
...
public type Available_phone_number record {
    # A formatted version of the phone number.
    string? friendly_name?;
    # The phone number in [E.164](https://www.twilio.com/docs/glossary/what-e164) format, which consists of a + followed by the country code and subscriber number.
    string? phone_number?;
...
public type ListIncomingPhoneNumberTollFreeResponse record {
    Incomming_phone_numIncoming_phone_number_toll_free[] incoming_phone_numbers?;
    int end?;
    string first_page_uri?;
    string? next_page_uri?;
    int page?;
...
# The set of Boolean properties that indicate whether a phone number can receive calls or messages.  Capabilities are  `Voice`, `SMS`, and `MMS` and each capability can be: `true` or `false`.
public type Incomming_phone_num_capabilities record {
    boolean mms?;
    boolean sms?;
    boolean voice?;
    boolean fax?;
...
public type ListAvailablePhoneNumberLocalResponse record {
    Available_phone_number[] available_phone_numbers?;
    int end?;
    string first_page_uri?;
    string? next_page_uri?;
    int page?;
...
public type Incomming_phone_numIncoming_phone_number_assigned_add_onIncoming_phone_number_assigned_add_on_extension record {
    # The unique string that that we created to identify the resource.
    string? sid?;
    # The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the resource.
    string? account_sid?;
