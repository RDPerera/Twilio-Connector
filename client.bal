...
public isolated client class Client {
    ...
    #
    # + return - Created 
    remote isolated function createAccount(CreateAccountRequest payload) returns ApiV2010Account|error {
        string resourcePath = string `/2010-04-01/Accounts.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010Account response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function fetchAccount(string sid) returns ApiV2010Account|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(sid)}.json`;
        ApiV2010Account response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function updateAccount(string sid, UpdateAccountRequest payload) returns ApiV2010Account|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + return - Created 
    remote isolated function createAddress(string accountSid, CreateAddressRequest payload) returns ApiV2010AccountAddress|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Addresses.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountAddress response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    #
    ...
    # + return - OK 
    remote isolated function fetchAddress(string accountSid, string sid) returns ApiV2010AccountAddress|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Addresses/${getEncodedUri(sid)}.json`;
        ApiV2010AccountAddress response = check self.clientEp->get(resourcePath);
        return response;
    }
    #
    ...
    # + return - OK 
    remote isolated function updateAddress(string accountSid, string sid, UpdateAddressRequest payload) returns ApiV2010AccountAddress|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Addresses/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + return - Created 
    remote isolated function createApplication(string accountSid, CreateApplicationRequest payload) returns ApiV2010AccountApplication|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Applications.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountApplication response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function fetchApplication(string accountSid, string sid) returns ApiV2010AccountApplication|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Applications/${getEncodedUri(sid)}.json`;
        ApiV2010AccountApplication response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function updateApplication(string accountSid, string sid, UpdateApplicationRequest payload) returns ApiV2010AccountApplication|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Applications/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + return - OK 
    remote isolated function fetchAuthorizedConnectApp(string accountSid, string connectAppSid) returns ApiV2010AccountAuthorized_connect_app|error {
        ...
        ApiV2010AccountAuthorized_connect_app response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function fetchAvailablePhoneNumberCountry(string accountSid, string countryCode) returns ApiV2010AccountAvailable_phone_number_country|error {
        ...
        ApiV2010AccountAvailable_phone_number_country response = check self.clientEp->get(resourcePath);
        return response;
    }
    #
    ...
    # + return - OK 
    remote isolated function fetchBalance(string accountSid) returns ApiV2010AccountBalance|error {
    ...
    # + startTimeAfter - Only include calls that started on this date. Specify a date as `YYYY-MM-DD` in GMT, for example: `2009-07-06`, to read only calls that started on this date. You can also specify an inequality, such as `StartTime<=YYYY-MM-DD`, to read calls that started on or before midnight of this date, and `StartTime>=YYYY-MM-DD` to read calls that started on or after midnight of this date.
    ...
    # + endTimeBefore - Only include calls that ended on this date. Specify a date as `YYYY-MM-DD` in GMT, for example: `2009-07-06`, to read only calls that ended on this date. You can also specify an inequality, such as `EndTime<=YYYY-MM-DD`, to read calls that ended on or before midnight of this date, and `EndTime>=YYYY-MM-DD` to read calls that ended on or after midnight of this date.
    # + endTimeAfter - Only include calls that ended on this date. Specify a date as `YYYY-MM-DD` in GMT, for example: `2009-07-06`, to read only calls that ended on this date. You can also specify an inequality, such as `EndTime<=YYYY-MM-DD`, to read calls that ended on or before midnight of this date, and `EndTime>=YYYY-MM-DD` to read calls that ended on or after midnight of this date.
    # + pageSize - How many resources to return in each list page. The default is 50, and the maximum is 1000.
    # + page - The page index. This value is simply for client state.
    # + pageToken - The page token. This is provided by the API.
    # + return - OK 
    remote isolated function listCall(string accountSid, string? to = (), string? 'from = (), string? parentCallSid = (), Call_enum_status? status = (), string? startTime = (), string? startTimeBefore = (), string? startTimeAfter = (), string? endTime = (), string? endTimeBefore = (), string? endTimeAfter = (), int? pageSize = (), int? page = (), string? pageToken = ()) returns ListCallResponse|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Calls.json`;
        map<anydata> queryParam = {"To": to, "From": 'from, "ParentCallSid": parentCallSid, "Status": status, "StartTime": startTime, "StartTime<": startTimeBefore, "StartTime>": startTimeAfter, "EndTime": endTime, "EndTime<": endTimeBefore, "EndTime>": endTimeAfter, "PageSize": pageSize, "Page": page, "PageToken": pageToken};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    # + accountSid - The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that will create the resource.
    # + return - Created 
    remote isolated function createCall(string accountSid, CreateCallRequest payload) returns ApiV2010AccountCall|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Calls.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountCall response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function fetchCall(string accountSid, string sid) returns ApiV2010AccountCall|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Calls/${getEncodedUri(sid)}.json`;
        ApiV2010AccountCall response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function updateCall(string accountSid, string sid, UpdateCallRequest payload) returns ApiV2010AccountCall|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Calls/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + return - OK 
    remote isolated function fetchCallFeedback(string accountSid, string callSid) returns ApiV2010AccountCallCall_feedback|error {
    ...
    # + callSid - The call sid that uniquely identifies the call
    # + return - OK 
    remote isolated function updateCallFeedback(string accountSid, string callSid, UpdateCallFeedbackRequest payload) returns ApiV2010AccountCallCall_feedback|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Calls/${getEncodedUri(callSid)}/Feedback.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountCallCall_feedback response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + accountSid - The unique id of the [Account](https://www.twilio.com/docs/iam/api/account) responsible for this resource.
    # + return - Created 
    remote isolated function createCallFeedbackSummary(string accountSid, CreateCallFeedbackSummaryRequest payload) returns ApiV2010AccountCallCall_feedback_summary|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Calls/FeedbackSummary.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountCallCall_feedback_summary response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function fetchCallFeedbackSummary(string accountSid, string sid) returns ApiV2010AccountCallCall_feedback_summary|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Calls/FeedbackSummary/${getEncodedUri(sid)}.json`;
        ApiV2010AccountCallCall_feedback_summary response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function fetchCallNotification(string accountSid, string callSid, string sid) returns ApiV2010AccountCallCall_notificationInstance|error {
        ...
        ApiV2010AccountCallCall_notificationInstance response = check self.clientEp->get(resourcePath);
        return response;
    }
    #
    ...
    # + messageDateBefore - Only show notifications for the specified date, formatted as `YYYY-MM-DD`. You can also specify an inequality, such as `<=YYYY-MM-DD` for messages logged at or before midnight on a date, or `>=YYYY-MM-DD` for messages logged at or after midnight on a date.
    # + messageDateAfter - Only show notifications for the specified date, formatted as `YYYY-MM-DD`. You can also specify an inequality, such as `<=YYYY-MM-DD` for messages logged at or before midnight on a date, or `>=YYYY-MM-DD` for messages logged at or after midnight on a date.
    # + pageSize - How many resources to return in each list page. The default is 50, and the maximum is 1000.
    # + page - The page index. This value is simply for client state.
    # + pageToken - The page token. This is provided by the API.
    # + return - OK 
    remote isolated function listCallNotification(string accountSid, string callSid, int? log = (), string? messageDate = (), string? messageDateBefore = (), string? messageDateAfter = (), int? pageSize = (), int? page = (), string? pageToken = ()) returns ListCallNotificationResponse|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Calls/${getEncodedUri(callSid)}/Notifications.json`;
        map<anydata> queryParam = {"Log": log, "MessageDate": messageDate, "MessageDate<": messageDateBefore, "MessageDate>": messageDateAfter, "PageSize": pageSize, "Page": page, "PageToken": pageToken};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    # + dateCreatedBefore - The `date_created` value, specified as `YYYY-MM-DD`, of the resources to read. You can also specify inequality: `DateCreated<=YYYY-MM-DD` will return recordings generated at or before midnight on a given date, and `DateCreated>=YYYY-MM-DD` returns recordings generated at or after midnight on a date.
    # + dateCreatedAfter - The `date_created` value, specified as `YYYY-MM-DD`, of the resources to read. You can also specify inequality: `DateCreated<=YYYY-MM-DD` will return recordings generated at or before midnight on a given date, and `DateCreated>=YYYY-MM-DD` returns recordings generated at or after midnight on a date.
    # + pageSize - How many resources to return in each list page. The default is 50, and the maximum is 1000.
    # + page - The page index. This value is simply for client state.
    # + pageToken - The page token. This is provided by the API.
    # + return - OK 
    remote isolated function listCallRecording(string accountSid, string callSid, string? dateCreated = (), string? dateCreatedBefore = (), string? dateCreatedAfter = (), int? pageSize = (), int? page = (), string? pageToken = ()) returns ListCallRecordingResponse|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Calls/${getEncodedUri(callSid)}/Recordings.json`;
        map<anydata> queryParam = {"DateCreated": dateCreated, "DateCreated<": dateCreatedBefore, "DateCreated>": dateCreatedAfter, "PageSize": pageSize, "Page": page, "PageToken": pageToken};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    # + return - Created 
    remote isolated function createCallRecording(string accountSid, string callSid, CreateCallRecordingRequest payload) returns ApiV2010AccountCallCall_recording|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Calls/${getEncodedUri(callSid)}/Recordings.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountCallCall_recording response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function fetchCallRecording(string accountSid, string callSid, string sid) returns ApiV2010AccountCallCall_recording|error {
        ...
        ApiV2010AccountCallCall_recording response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function updateCallRecording(string accountSid, string callSid, string sid, UpdateCallRecordingRequest payload) returns ApiV2010AccountCallCall_recording|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Calls/${getEncodedUri(callSid)}/Recordings/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + return - OK 
    remote isolated function fetchConference(string accountSid, string sid) returns ApiV2010AccountConference|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Conferences/${getEncodedUri(sid)}.json`;
        ApiV2010AccountConference response = check self.clientEp->get(resourcePath);
        return response;
    }
    #
    ...
    # + return - OK 
    remote isolated function updateConference(string accountSid, string sid, UpdateConferenceRequest payload) returns ApiV2010AccountConference|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Conferences/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountConference response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + dateCreatedBefore - The `date_created` value, specified as `YYYY-MM-DD`, of the resources to read. To read conferences that started on or before midnight on a date, use `<=YYYY-MM-DD`, and to specify  conferences that started on or after midnight on a date, use `>=YYYY-MM-DD`.
    # + dateCreatedAfter - The `date_created` value, specified as `YYYY-MM-DD`, of the resources to read. To read conferences that started on or before midnight on a date, use `<=YYYY-MM-DD`, and to specify  conferences that started on or after midnight on a date, use `>=YYYY-MM-DD`.
    ...
    # + dateUpdatedBefore - The `date_updated` value, specified as `YYYY-MM-DD`, of the resources to read. To read conferences that were last updated on or before midnight on a date, use `<=YYYY-MM-DD`, and to specify conferences that were last updated on or after midnight on a given date, use  `>=YYYY-MM-DD`.
    # + dateUpdatedAfter - The `date_updated` value, specified as `YYYY-MM-DD`, of the resources to read. To read conferences that were last updated on or before midnight on a date, use `<=YYYY-MM-DD`, and to specify conferences that were last updated on or after midnight on a given date, use  `>=YYYY-MM-DD`.
    ...
    # + pageToken - The page token. This is provided by the API.
    # + return - OK 
    remote isolated function listConference(string accountSid, string? dateCreated = (), string? dateCreatedBefore = (), string? dateCreatedAfter = (), string? dateUpdated = (), string? dateUpdatedBefore = (), string? dateUpdatedAfter = (), string? friendlyName = (), Conference_enum_status? status = (), int? pageSize = (), int? page = (), string? pageToken = ()) returns ListConferenceResponse|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Conferences.json`;
        map<anydata> queryParam = {"DateCreated": dateCreated, "DateCreated<": dateCreatedBefore, "DateCreated>": dateCreatedAfter, "DateUpdated": dateUpdated, "DateUpdated<": dateUpdatedBefore, "DateUpdated>": dateUpdatedAfter, "FriendlyName": friendlyName, "Status": status, "PageSize": pageSize, "Page": page, "PageToken": pageToken};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    # + return - OK 
    remote isolated function fetchConferenceRecording(string accountSid, string conferenceSid, string sid) returns ApiV2010AccountConferenceConference_recording|error {
        ...
        ApiV2010AccountConferenceConference_recording response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function updateConferenceRecording(string accountSid, string conferenceSid, string sid, UpdateConferenceRecordingRequest payload) returns ApiV2010AccountConferenceConference_recording|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Conferences/${getEncodedUri(conferenceSid)}/Recordings/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountConferenceConference_recording response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    # Delete a recording from your account
    #
    ...
    # + pageToken - The page token. This is provided by the API.
    # + return - OK 
    remote isolated function listConferenceRecording(string accountSid, string conferenceSid, string? dateCreated = (), string? dateCreatedBefore = (), string? dateCreatedAfter = (), int? pageSize = (), int? page = (), string? pageToken = ()) returns ListConferenceRecordingResponse|error {
    ...
    # + return - OK 
    remote isolated function fetchConnectApp(string accountSid, string sid) returns ApiV2010AccountConnect_app|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/ConnectApps/${getEncodedUri(sid)}.json`;
        ApiV2010AccountConnect_app response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function updateConnectApp(string accountSid, string sid, UpdateConnectAppRequest payload) returns ApiV2010AccountConnect_app|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/ConnectApps/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountConnect_app response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function fetchIncomingPhoneNumber(string accountSid, string sid) returns Incomming_phone_num|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/IncomingPhoneNumbers/${getEncodedUri(sid)}.json`;
        Incomming_phone_num response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function updateIncomingPhoneNumber(string accountSid, string sid, UpdateIncomingPhoneNumberRequest payload) returns Incomming_phone_num|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/IncomingPhoneNumbers/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        Incomming_phone_num response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + accountSid - The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that will create the resource.
    # + return - Created 
    remote isolated function createIncomingPhoneNumber(string accountSid, CreateIncomingPhoneNumberRequest payload) returns Incomming_phone_num|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/IncomingPhoneNumbers.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + return - OK 
    remote isolated function fetchIncomingPhoneNumberAssignedAddOn(string accountSid, string resourceSid, string sid) returns Incomming_phone_numIncoming_phone_number_assigned_add_on|error {
        ...
        Incomming_phone_numIncoming_phone_number_assigned_add_on response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - Created 
    remote isolated function createIncomingPhoneNumberAssignedAddOn(string accountSid, string resourceSid, CreateIncomingPhoneNumberAssignedAddOnRequest payload) returns Incomming_phone_numIncoming_phone_number_assigned_add_on|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/IncomingPhoneNumbers/${getEncodedUri(resourceSid)}/AssignedAddOns.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        Incomming_phone_numIncoming_phone_number_assigned_add_on response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + sid - The Twilio-provided string that uniquely identifies the resource to fetch.
    # + return - OK 
    remote isolated function fetchIncomingPhoneNumberAssignedAddOnExtension(string accountSid, string resourceSid, string assignedAddOnSid, string sid) returns Incomming_phone_numIncoming_phone_number_assigned_add_onIncoming_phone_number_assigned_add_on_extension|error {
        ...
        Incomming_phone_numIncoming_phone_number_assigned_add_onIncoming_phone_number_assigned_add_on_extension response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + accountSid - The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that will create the resource.
    # + return - Created 
    remote isolated function createIncomingPhoneNumberLocal(string accountSid, CreateIncomingPhoneNumberLocalRequest payload) returns Incomming_phone_numIncoming_phone_number_local|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/IncomingPhoneNumbers/Local.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        Incomming_phone_numIncoming_phone_number_local response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    #
    # + accountSid - The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the resources to read.
    ...
    # + accountSid - The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that will create the resource.
    # + return - Created 
    remote isolated function createIncomingPhoneNumberMobile(string accountSid, CreateIncomingPhoneNumberMobileRequest payload) returns Incomming_phone_numIncoming_phone_number_mobile|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/IncomingPhoneNumbers/Mobile.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        Incomming_phone_numIncoming_phone_number_mobile response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    #
    # + accountSid - The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the resources to read.
    ...
    # + accountSid - The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that will create the resource.
    # + return - Created 
    remote isolated function createIncomingPhoneNumberTollFree(string accountSid, CreateIncomingPhoneNumberTollFreeRequest payload) returns Incomming_phone_numIncoming_phone_number_toll_free|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/IncomingPhoneNumbers/TollFree.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        Incomming_phone_numIncoming_phone_number_toll_free response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    #
    ...
    # + return - OK 
    remote isolated function fetchKey(string accountSid, string sid) returns ApiV2010AccountKey|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Keys/${getEncodedUri(sid)}.json`;
        ApiV2010AccountKey response = check self.clientEp->get(resourcePath);
        return response;
    }
    #
    ...
    # + return - OK 
    remote isolated function updateKey(string accountSid, string sid, UpdateKeyRequest payload) returns ApiV2010AccountKey|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Keys/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountKey response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    #
    ...
    # + return - Created 
    remote isolated function createNewKey(string accountSid, CreateNewKeyRequest payload) returns ApiV2010AccountNew_key|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Keys.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountNew_key response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function fetchMedia(string accountSid, string messageSid, string sid) returns ApiV2010AccountMessageMedia|error {
        ...
        ApiV2010AccountMessageMedia response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + dateCreatedBefore - Only include Media resources that were created on this date. Specify a date as `YYYY-MM-DD` in GMT, for example: `2009-07-06`, to read Media that were created on this date. You can also specify an inequality, such as `StartTime<=YYYY-MM-DD`, to read Media that were created on or before midnight of this date, and `StartTime>=YYYY-MM-DD` to read Media that were created on or after midnight of this date.
    # + dateCreatedAfter - Only include Media resources that were created on this date. Specify a date as `YYYY-MM-DD` in GMT, for example: `2009-07-06`, to read Media that were created on this date. You can also specify an inequality, such as `StartTime<=YYYY-MM-DD`, to read Media that were created on or before midnight of this date, and `StartTime>=YYYY-MM-DD` to read Media that were created on or after midnight of this date.
    # + pageSize - How many resources to return in each list page. The default is 50, and the maximum is 1000.
    # + page - The page index. This value is simply for client state.
    # + pageToken - The page token. This is provided by the API.
    # + return - OK 
    remote isolated function listMedia(string accountSid, string messageSid, string? dateCreated = (), string? dateCreatedBefore = (), string? dateCreatedAfter = (), int? pageSize = (), int? page = (), string? pageToken = ()) returns ListMediaResponse|error {
    ...
    # + return - OK 
    remote isolated function fetchMember(string accountSid, string queueSid, string callSid) returns ApiV2010AccountQueueMember|error {
        ...
        ApiV2010AccountQueueMember response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function updateMember(string accountSid, string queueSid, string callSid, UpdateMemberRequest payload) returns ApiV2010AccountQueueMember|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Queues/${getEncodedUri(queueSid)}/Members/${getEncodedUri(callSid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountQueueMember response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + dateSentBefore - Filter by Message `sent_date`. Accepts GMT dates in the following formats: `YYYY-MM-DD` (to find Messages with a specific `sent_date`), `<=YYYY-MM-DD` (to find Messages with `sent_date`s on and before a specific date), and `>=YYYY-MM-DD` (to find Messages with `sent_dates` on and after a specific date).
    # + dateSentAfter - Filter by Message `sent_date`. Accepts GMT dates in the following formats: `YYYY-MM-DD` (to find Messages with a specific `sent_date`), `<=YYYY-MM-DD` (to find Messages with `sent_date`s on and before a specific date), and `>=YYYY-MM-DD` (to find Messages with `sent_dates` on and after a specific date).
    # + pageSize - How many resources to return in each list page. The default is 50, and the maximum is 1000.
    # + page - The page index. This value is simply for client state.
    # + pageToken - The page token. This is provided by the API.
    # + return - OK 
    remote isolated function listMessage(string accountSid, string? to = (), string? 'from = (), string? dateSent = (), string? dateSentBefore = (), string? dateSentAfter = (), int? pageSize = (), int? page = (), string? pageToken = ()) returns ListMessageResponse|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Messages.json`;
        map<anydata> queryParam = {"To": to, "From": 'from, "DateSent": dateSent, "DateSent<": dateSentBefore, "DateSent>": dateSentAfter, "PageSize": pageSize, "Page": page, "PageToken": pageToken};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    # + return - Created 
    remote isolated function createMessage(string accountSid, CreateMessageRequest payload) returns ApiV2010AccountMessage|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Messages.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountMessage response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function fetchMessage(string accountSid, string sid) returns ApiV2010AccountMessage|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Messages/${getEncodedUri(sid)}.json`;
        ApiV2010AccountMessage response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function updateMessage(string accountSid, string sid, UpdateMessageRequest payload) returns ApiV2010AccountMessage|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Messages/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + return - Created 
    remote isolated function createMessageFeedback(string accountSid, string messageSid, CreateMessageFeedbackRequest payload) returns ApiV2010AccountMessageMessage_feedback|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Messages/${getEncodedUri(messageSid)}/Feedback.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountMessageMessage_feedback response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    #
    # + pageSize - How many resources to return in each list page. The default is 50, and the maximum is 1000.
    ...
    # + accountSid - The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that will be responsible for the new Key resource.
    # + return - Created 
    remote isolated function createNewSigningKey(string accountSid, CreateNewSigningKeyRequest payload) returns ApiV2010AccountNew_signing_key|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SigningKeys.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountNew_signing_key response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function fetchNotification(string accountSid, string sid) returns ApiV2010AccountNotificationInstance|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Notifications/${getEncodedUri(sid)}.json`;
        ApiV2010AccountNotificationInstance response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + pageToken - The page token. This is provided by the API.
    # + return - OK 
    remote isolated function listNotification(string accountSid, int? log = (), string? messageDate = (), string? messageDateBefore = (), string? messageDateAfter = (), int? pageSize = (), int? page = (), string? pageToken = ()) returns ListNotificationResponse|error {
    ...
    # + return - OK 
    remote isolated function fetchOutgoingCallerId(string accountSid, string sid) returns ApiV2010AccountOutgoing_caller_id|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/OutgoingCallerIds/${getEncodedUri(sid)}.json`;
        ApiV2010AccountOutgoing_caller_id response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function updateOutgoingCallerId(string accountSid, string sid, UpdateOutgoingCallerIdRequest payload) returns ApiV2010AccountOutgoing_caller_id|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/OutgoingCallerIds/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountOutgoing_caller_id response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - Created 
    remote isolated function createValidationRequest(string accountSid, CreateValidationRequestRequest payload) returns ApiV2010AccountValidation_request|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/OutgoingCallerIds.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountValidation_request response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function fetchParticipant(string accountSid, string conferenceSid, string callSid) returns ApiV2010AccountConferenceParticipant|error {
        ...
        ApiV2010AccountConferenceParticipant response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function updateParticipant(string accountSid, string conferenceSid, string callSid, UpdateParticipantRequest payload) returns ApiV2010AccountConferenceParticipant|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Conferences/${getEncodedUri(conferenceSid)}/Participants/${getEncodedUri(callSid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountConferenceParticipant response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - Created 
    remote isolated function createParticipant(string accountSid, string conferenceSid, CreateParticipantRequest payload) returns ApiV2010AccountConferenceParticipant|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Conferences/${getEncodedUri(conferenceSid)}/Participants.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + return - Created 
    remote isolated function createPayments(string accountSid, string callSid, CreatePaymentsRequest payload) returns ApiV2010AccountCallPayments|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Calls/${getEncodedUri(callSid)}/Payments.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountCallPayments response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - Accepted 
    remote isolated function updatePayments(string accountSid, string callSid, string sid, UpdatePaymentsRequest payload) returns ApiV2010AccountCallPayments|error {
    ...
    # + return - OK 
    remote isolated function fetchQueue(string accountSid, string sid) returns ApiV2010AccountQueue|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Queues/${getEncodedUri(sid)}.json`;
        ApiV2010AccountQueue response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function updateQueue(string accountSid, string sid, UpdateQueueRequest payload) returns ApiV2010AccountQueue|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Queues/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountQueue response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + accountSid - The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that will create the resource.
    # + return - Created 
    remote isolated function createQueue(string accountSid, CreateQueueRequest payload) returns ApiV2010AccountQueue|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Queues.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + return - OK 
    remote isolated function fetchRecording(string accountSid, string sid, boolean? includeSoftDeleted = ()) returns ApiV2010AccountRecording|error {
        ...
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        ApiV2010AccountRecording response = check self.clientEp->get(resourcePath);
        return response;
    }
    # Delete a recording from your account
    #
    ...
    # + dateCreatedBefore - Only include recordings that were created on this date. Specify a date as `YYYY-MM-DD` in GMT, for example: `2009-07-06`, to read recordings that were created on this date. You can also specify an inequality, such as `DateCreated<=YYYY-MM-DD`, to read recordings that were created on or before midnight of this date, and `DateCreated>=YYYY-MM-DD` to read recordings that were created on or after midnight of this date.
    # + dateCreatedAfter - Only include recordings that were created on this date. Specify a date as `YYYY-MM-DD` in GMT, for example: `2009-07-06`, to read recordings that were created on this date. You can also specify an inequality, such as `DateCreated<=YYYY-MM-DD`, to read recordings that were created on or before midnight of this date, and `DateCreated>=YYYY-MM-DD` to read recordings that were created on or after midnight of this date.
    # + callSid - The [Call](https://www.twilio.com/docs/voice/api/call-resource) SID of the resources to read.
    # + conferenceSid - The Conference SID that identifies the conference associated with the recording to read.
    # + includeSoftDeleted - A boolean parameter indicating whether to retrieve soft deleted recordings or not. Recordings metadata are kept after deletion for a retention period of 40 days.
    # + pageSize - How many resources to return in each list page. The default is 50, and the maximum is 1000.
    ...
    # + pageToken - The page token. This is provided by the API.
    # + return - OK 
    remote isolated function listRecording(string accountSid, string? dateCreated = (), string? dateCreatedBefore = (), string? dateCreatedAfter = (), string? callSid = (), string? conferenceSid = (), boolean? includeSoftDeleted = (), int? pageSize = (), int? page = (), string? pageToken = ()) returns ListRecordingResponse|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Recordings.json`;
        map<anydata> queryParam = {"DateCreated": dateCreated, "DateCreated<": dateCreatedBefore, "DateCreated>": dateCreatedAfter, "CallSid": callSid, "ConferenceSid": conferenceSid, "IncludeSoftDeleted": includeSoftDeleted, "PageSize": pageSize, "Page": page, "PageToken": pageToken};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    # + return - OK 
    remote isolated function fetchRecordingAddOnResult(string accountSid, string referenceSid, string sid) returns ApiV2010AccountRecordingRecording_add_on_result|error {
        ...
        ApiV2010AccountRecordingRecording_add_on_result response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function fetchRecordingAddOnResultPayload(string accountSid, string referenceSid, string addOnResultSid, string sid) returns ApiV2010AccountRecordingRecording_add_on_resultRecording_add_on_result_payload|error {
        ...
        ApiV2010AccountRecordingRecording_add_on_resultRecording_add_on_result_payload response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function fetchRecordingTranscription(string accountSid, string recordingSid, string sid) returns ApiV2010AccountRecordingRecording_transcription|error {
        ...
        ApiV2010AccountRecordingRecording_transcription response = check self.clientEp->get(resourcePath);
        return response;
    }
    #
    ...
    # + return - OK 
    remote isolated function fetchSafelist(string? phoneNumber = ()) returns ApiV2010Safelist|error {
        string resourcePath = string `/2010-04-01/SafeList/Numbers.json`;
        map<anydata> queryParam = {"PhoneNumber": phoneNumber};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        ApiV2010Safelist response = check self.clientEp->get(resourcePath);
        return response;
    }
    # Add a new phone number to SafeList.
    #
    # + return - Created 
    remote isolated function createSafelist(CreateSafelistRequest payload) returns ApiV2010Safelist|error {
        string resourcePath = string `/2010-04-01/SafeList/Numbers.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010Safelist response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - The resource was deleted successfully. 
    remote isolated function deleteSafelist(string? phoneNumber = ()) returns http:Response|error {
        string resourcePath = string `/2010-04-01/SafeList/Numbers.json`;
        map<anydata> queryParam = {"PhoneNumber": phoneNumber};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        http:Response response = check self.clientEp-> delete(resourcePath);
    ...
    # + return - OK 
    remote isolated function fetchShortCode(string accountSid, string sid) returns ApiV2010AccountShort_code|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SMS/ShortCodes/${getEncodedUri(sid)}.json`;
        ApiV2010AccountShort_code response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function updateShortCode(string accountSid, string sid, UpdateShortCodeRequest payload) returns ApiV2010AccountShort_code|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SMS/ShortCodes/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountShort_code response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    #
    # + return - OK 
    remote isolated function fetchSigningKey(string accountSid, string sid) returns ApiV2010AccountSigning_key|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SigningKeys/${getEncodedUri(sid)}.json`;
        ApiV2010AccountSigning_key response = check self.clientEp->get(resourcePath);
        return response;
    }
    #
    # + return - OK 
    remote isolated function updateSigningKey(string accountSid, string sid, UpdateSigningKeyRequest payload) returns ApiV2010AccountSigning_key|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SigningKeys/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountSigning_key response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    #
    # + return - The resource was deleted successfully. 
    ...
    # + return - Created 
    remote isolated function createSipAuthCallsCredentialListMapping(string accountSid, string domainSid, CreateSipAuthCallsCredentialListMappingRequest payload) returns ApiV2010AccountSipSip_domainSip_authSip_auth_callsSip_auth_calls_credential_list_mapping|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SIP/Domains/${getEncodedUri(domainSid)}/Auth/Calls/CredentialListMappings.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountSipSip_domainSip_authSip_auth_callsSip_auth_calls_credential_list_mapping response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function fetchSipAuthCallsCredentialListMapping(string accountSid, string domainSid, string sid) returns ApiV2010AccountSipSip_domainSip_authSip_auth_callsSip_auth_calls_credential_list_mapping|error {
        ...
        ApiV2010AccountSipSip_domainSip_authSip_auth_callsSip_auth_calls_credential_list_mapping response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + domainSid - The SID of the SIP domain that will contain the new resource.
    # + return - Created 
    remote isolated function createSipAuthCallsIpAccessControlListMapping(string accountSid, string domainSid, CreateSipAuthCallsIpAccessControlListMappingRequest payload) returns ApiV2010AccountSipSip_domainSip_authSip_auth_callsSip_auth_calls_ip_access_control_list_mapping|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SIP/Domains/${getEncodedUri(domainSid)}/Auth/Calls/IpAccessControlListMappings.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountSipSip_domainSip_authSip_auth_callsSip_auth_calls_ip_access_control_list_mapping response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function fetchSipAuthCallsIpAccessControlListMapping(string accountSid, string domainSid, string sid) returns ApiV2010AccountSipSip_domainSip_authSip_auth_callsSip_auth_calls_ip_access_control_list_mapping|error {
        ...
        ApiV2010AccountSipSip_domainSip_authSip_auth_callsSip_auth_calls_ip_access_control_list_mapping response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + domainSid - The SID of the SIP domain that will contain the new resource.
    # + return - Created 
    remote isolated function createSipAuthRegistrationsCredentialListMapping(string accountSid, string domainSid, CreateSipAuthRegistrationsCredentialListMappingRequest payload) returns ApiV2010AccountSipSip_domainSip_authSip_auth_registrationsSip_auth_registrations_credential_list_mapping|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SIP/Domains/${getEncodedUri(domainSid)}/Auth/Registrations/CredentialListMappings.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountSipSip_domainSip_authSip_auth_registrationsSip_auth_registrations_credential_list_mapping response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    # Fetch a specific instance of a credential list mapping
    #
    ...
    # + sid - The Twilio-provided string that uniquely identifies the CredentialListMapping resource to fetch.
    # + return - OK 
    remote isolated function fetchSipAuthRegistrationsCredentialListMapping(string accountSid, string domainSid, string sid) returns ApiV2010AccountSipSip_domainSip_authSip_auth_registrationsSip_auth_registrations_credential_list_mapping|error {
        ...
        ApiV2010AccountSipSip_domainSip_authSip_auth_registrationsSip_auth_registrations_credential_list_mapping response = check self.clientEp->get(resourcePath);
        return response;
    }
    # Delete a credential list mapping from the requested domain
    #
    ...
    # + return - Created 
    remote isolated function createSipCredential(string accountSid, string credentialListSid, CreateSipCredentialRequest payload) returns ApiV2010AccountSipSip_credential_listSip_credential|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SIP/CredentialLists/${getEncodedUri(credentialListSid)}/Credentials.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountSipSip_credential_listSip_credential response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function fetchSipCredential(string accountSid, string credentialListSid, string sid) returns ApiV2010AccountSipSip_credential_listSip_credential|error {
        ...
        ApiV2010AccountSipSip_credential_listSip_credential response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function updateSipCredential(string accountSid, string credentialListSid, string sid, UpdateSipCredentialRequest payload) returns ApiV2010AccountSipSip_credential_listSip_credential|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SIP/CredentialLists/${getEncodedUri(credentialListSid)}/Credentials/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + accountSid - The unique id of the Account that is responsible for this resource.
    # + return - Created 
    remote isolated function createSipCredentialList(string accountSid, CreateSipCredentialListRequest payload) returns ApiV2010AccountSipSip_credential_list|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SIP/CredentialLists.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountSipSip_credential_list response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function fetchSipCredentialList(string accountSid, string sid) returns ApiV2010AccountSipSip_credential_list|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SIP/CredentialLists/${getEncodedUri(sid)}.json`;
        ApiV2010AccountSipSip_credential_list response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + sid - The credential list Sid that uniquely identifies this resource
    # + return - OK 
    remote isolated function updateSipCredentialList(string accountSid, string sid, UpdateSipCredentialListRequest payload) returns ApiV2010AccountSipSip_credential_list|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SIP/CredentialLists/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + return - Created 
    remote isolated function createSipCredentialListMapping(string accountSid, string domainSid, CreateSipCredentialListMappingRequest payload) returns ApiV2010AccountSipSip_domainSip_credential_list_mapping|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SIP/Domains/${getEncodedUri(domainSid)}/CredentialListMappings.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountSipSip_domainSip_credential_list_mapping response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function fetchSipCredentialListMapping(string accountSid, string domainSid, string sid) returns ApiV2010AccountSipSip_domainSip_credential_list_mapping|error {
        ...
        ApiV2010AccountSipSip_domainSip_credential_list_mapping response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + accountSid - The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that will create the resource.
    # + return - Created 
    remote isolated function createSipDomain(string accountSid, CreateSipDomainRequest payload) returns ApiV2010AccountSipSip_domain|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SIP/Domains.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountSipSip_domain response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function fetchSipDomain(string accountSid, string sid) returns ApiV2010AccountSipSip_domain|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SIP/Domains/${getEncodedUri(sid)}.json`;
        ApiV2010AccountSipSip_domain response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function updateSipDomain(string accountSid, string sid, UpdateSipDomainRequest payload) returns ApiV2010AccountSipSip_domain|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SIP/Domains/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + accountSid - The unique id of the [Account](https://www.twilio.com/docs/iam/api/account) responsible for this resource.
    # + return - Created 
    remote isolated function createSipIpAccessControlList(string accountSid, CreateSipIpAccessControlListRequest payload) returns ApiV2010AccountSipSip_ip_access_control_list|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SIP/IpAccessControlLists.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountSipSip_ip_access_control_list response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + sid - A 34 character string that uniquely identifies the resource to fetch.
    # + return - OK 
    remote isolated function fetchSipIpAccessControlList(string accountSid, string sid) returns ApiV2010AccountSipSip_ip_access_control_list|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SIP/IpAccessControlLists/${getEncodedUri(sid)}.json`;
        ApiV2010AccountSipSip_ip_access_control_list response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function updateSipIpAccessControlList(string accountSid, string sid, UpdateSipIpAccessControlListRequest payload) returns ApiV2010AccountSipSip_ip_access_control_list|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SIP/IpAccessControlLists/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + sid - A 34 character string that uniquely identifies the resource to fetch.
    # + return - OK 
    remote isolated function fetchSipIpAccessControlListMapping(string accountSid, string domainSid, string sid) returns ApiV2010AccountSipSip_domainSip_ip_access_control_list_mapping|error {
        ...
        ApiV2010AccountSipSip_domainSip_ip_access_control_list_mapping response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + domainSid - A 34 character string that uniquely identifies the SIP domain.
    # + return - Created 
    remote isolated function createSipIpAccessControlListMapping(string accountSid, string domainSid, CreateSipIpAccessControlListMappingRequest payload) returns ApiV2010AccountSipSip_domainSip_ip_access_control_list_mapping|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SIP/Domains/${getEncodedUri(domainSid)}/IpAccessControlListMappings.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountSipSip_domainSip_ip_access_control_list_mapping response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - Created 
    remote isolated function createSipIpAddress(string accountSid, string ipAccessControlListSid, CreateSipIpAddressRequest payload) returns ApiV2010AccountSipSip_ip_access_control_listSip_ip_address|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SIP/IpAccessControlLists/${getEncodedUri(ipAccessControlListSid)}/IpAddresses.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountSipSip_ip_access_control_listSip_ip_address response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function fetchSipIpAddress(string accountSid, string ipAccessControlListSid, string sid) returns ApiV2010AccountSipSip_ip_access_control_listSip_ip_address|error {
        ...
        ApiV2010AccountSipSip_ip_access_control_listSip_ip_address response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function updateSipIpAddress(string accountSid, string ipAccessControlListSid, string sid, UpdateSipIpAddressRequest payload) returns ApiV2010AccountSipSip_ip_access_control_listSip_ip_address|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/SIP/IpAccessControlLists/${getEncodedUri(ipAccessControlListSid)}/IpAddresses/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + return - Created 
    remote isolated function createSiprec(string accountSid, string callSid, CreateSiprecRequest payload) returns ApiV2010AccountCallSiprec|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Calls/${getEncodedUri(callSid)}/Siprec.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountCallSiprec response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function updateSiprec(string accountSid, string callSid, string sid, UpdateSiprecRequest payload) returns ApiV2010AccountCallSiprec|error {
    ...
    # + return - Created 
    remote isolated function createStream(string accountSid, string callSid, CreateStreamRequest payload) returns ApiV2010AccountCallStream|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Calls/${getEncodedUri(callSid)}/Streams.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountCallStream response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function updateStream(string accountSid, string callSid, string sid, UpdateStreamRequest payload) returns ApiV2010AccountCallStream|error {
    ...
    # + sid - The Twilio-provided string that uniquely identifies the Transcription resource to fetch.
    # + return - OK 
    remote isolated function fetchTranscription(string accountSid, string sid) returns ApiV2010AccountTranscription|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Transcriptions/${getEncodedUri(sid)}.json`;
        ApiV2010AccountTranscription response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function fetchUsageTrigger(string accountSid, string sid) returns ApiV2010AccountUsageUsage_trigger|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Usage/Triggers/${getEncodedUri(sid)}.json`;
        ApiV2010AccountUsageUsage_trigger response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    # + return - OK 
    remote isolated function updateUsageTrigger(string accountSid, string sid, UpdateUsageTriggerRequest payload) returns ApiV2010AccountUsageUsage_trigger|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Usage/Triggers/${getEncodedUri(sid)}.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountUsageUsage_trigger response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    #
    ...
    # + accountSid - The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that will create the resource.
    # + return - Created 
    remote isolated function createUsageTrigger(string accountSid, CreateUsageTriggerRequest payload) returns ApiV2010AccountUsageUsage_trigger|error {
        string resourcePath = string `/2010-04-01/Accounts/${getEncodedUri(accountSid)}/Usage/Triggers.json`;
        http:Request request = new;
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
    ...
    # + return - Created 
    remote isolated function createUserDefinedMessage(string accountSid, string callSid, CreateUserDefinedMessageRequest payload) returns ApiV2010AccountCallUser_defined_message|error {
        ...
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountCallUser_defined_message response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    # + return - Created 
    remote isolated function createUserDefinedMessageSubscription(string accountSid, string callSid, CreateUserDefinedMessageSubscriptionRequest payload) returns ApiV2010AccountCallUser_defined_message_subscription|error {
        ...
        string encodedRequestBody = createFormURLEncodedRequestBody(payload);
        request.setPayload(encodedRequestBody, "application/x-www-form-urlencoded");
        ApiV2010AccountCallUser_defined_message_subscription response = check self.clientEp->post(resourcePath, request);
        return response;
    }
